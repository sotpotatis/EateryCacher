...
run_server = config.getboolean(
    "server", "run_using_default_server"
)  # Whether the server should be ran using the default Flask server (load this as a boolean value)
